...
$(document).ready(function(){
    ...
    //设置原来的内容
    zy_set_common.zy_set_old_content(zy_media_id,config.uploadMediaTypes.flash);

    //上传缩略图部分代码
    zy_set_common.zy_create_thumb_uploader(zy_media_id);

    //上传缩略图部分
    zy_set_common.zy_create_media_uploader(config.uploadFilters.flashFilter,zy_media_id);
