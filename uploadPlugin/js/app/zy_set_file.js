...
$(document).ready(function(){
    ...
    //设置原来的内容
    zy_set_common.zy_set_old_content(zy_media_id,config.uploadMediaTypes.file);

    //上传罗略图部分代码
    zy_set_common.zy_create_thumb_uploader(zy_media_id);

    //上传视频文件部分代码
    zy_set_common.zy_create_media_uploader(config.uploadFilters.fileFilter,zy_media_id);
